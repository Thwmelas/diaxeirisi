...
* ROS 2 Python Nodes:`odometry_reader.py`:reads real-time X, Y, Z telemetry data from the drones, and trying to implement `takeoff.py`: automates PX4 Offboard mode arming and executes a 5-meter takeoff
